...
class UserApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiSearchAddressAddressGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiSearchAddressAddressGet200Response>>
    ...
    final _path = r'/api/search/address/{address}'.replaceAll(
        '{' r'address' '}',
    ...
    ApiSearchAddressAddressGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiSearchAddressAddressGet200Response),
            ) as ApiSearchAddressAddressGet200Response;
    ...
    return Response<ApiSearchAddressAddressGet200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiSearchDidDidGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiSearchDidDidGet200Response>> apiSearchDidDidGet({
    required String did,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/search/did/{did}'.replaceAll(
        '{' r'did' '}',
        encodeQueryParameter(_serializers, did, const FullType(String))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    ApiSearchDidDidGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiSearchDidDidGet200Response),
            ) as ApiSearchDidDidGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiSearchDidDidGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiUserAddressBalanceGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiUserAddressBalanceGet200Response>>
    ...
    final _path = r'/api/user/{address}/balance'.replaceAll(
        '{' r'address' '}',
        encodeQueryParameter(_serializers, address, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ApiUserAddressBalanceGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType:
                  const FullType(ApiUserAddressBalanceGet200Response),
            ) as ApiUserAddressBalanceGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiUserAddressBalanceGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiUserAddressGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiUserAddressGet200Response>> apiUserAddressGet({
    required String address,
    bool? includeZeroBalance = false,
    String? pageToken,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/user/{address}'.replaceAll(
        '{' r'address' '}',
        encodeQueryParameter(_serializers, address, const FullType(String))
            .toString());
    final _options = Options(
    ...
    ApiUserAddressGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiUserAddressGet200Response),
            ) as ApiUserAddressGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiUserAddressGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [address] - Ethereum address of the user
  /// * [includeMetadata] - Whether to include metadata for NFTs
  /// * [pageToken] - Token for pagination, obtained from nextPageToken in previous response
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiUserAddressNftsGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiUserAddressNftsGet200Response>> apiUserAddressNftsGet({
    required String address,
    ...
    final _path = r'/api/user/{address}/nfts'.replaceAll(
        '{' r'address' '}',
        encodeQueryParameter(_serializers, address, const FullType(String))
            .toString());
    final _options = Options(
    ...
    final _queryParameters = <String, dynamic>{
      if (includeMetadata != null)
        r'include_metadata': encodeQueryParameter(
            _serializers, includeMetadata, const FullType(bool)),
      if (pageToken != null)
        r'pageToken': encodeQueryParameter(
            _serializers, pageToken, const FullType(String)),
    };
    ...
    ApiUserAddressNftsGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(ApiUserAddressNftsGet200Response),
            ) as ApiUserAddressNftsGet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ApiUserAddressNftsGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
